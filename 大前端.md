...
[vscode提示‘Vetur find `tsconfig.json`/`jsconfig.json`, but they aren‘t in the project root.’](https://blog.csdn.net/jsjcmq/article/details/110926639)
...
### 4. Vue CLI命令vue create及项目配置



### 5. Vue CLI命令扩展使用vue ui



### 6. Vue、Vue-router、Vuex综合应用
